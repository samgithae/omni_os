  ...
  <div class="mx-auto max-w-2xl pb-16">
    ...
    <form @submit.prevent="submit" class="space-y-4 px-4 pt-4">
      ...
      <div>
        ...
        <p v-else class="mt-1 text-[10px] text-gray-400">Machine handle — lowercase, underscores.</p>
      </div>
      ...
      <div>
        ...
        <textarea
          ...
          class="mt-1 block w-full rounded-lg border border-gray-300 px-3 py-2 text-xs outline-none focus:border-blue-400 focus:ring-1 focus:ring-blue-300 resize-none"
        ></textarea>
      </div>
