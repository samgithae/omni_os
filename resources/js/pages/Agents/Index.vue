    ...
    <div class="pb-16">
        ...
        >
            ...
            <p class="mt-1 text-xs text-gray-400">
                Create agents in the admin panel to get started
            </p>
        </div>
        ...
        <div v-else class="divide-y divide-gray-100">
            ...
            >
                ...
                >
                    <!-- Avatar -->
                    <div
                        class="h-10 w-10 shrink-0 overflow-hidden rounded-full bg-gray-200"
                    >
                        <img
                    ...
                    <div class="min-w-0 flex-1">
                        <div class="flex items-center gap-2">
                            ...
                            <span
                                class="inline-flex items-center gap-1 rounded-full bg-gray-100 px-1.5 py-0.5 font-mono text-[10px] text-gray-600"
                                >{{ agent.codename }}</span
                            >
                            <!-- Paused badge -->
                            <span
                        ...
                        <div
                            class="mt-0.5 flex items-center gap-2 text-[11px] text-gray-500"
                        >
                            <span v-if="agent.role">{{ agent.role }}</span>
                            <span
                                v-if="agent.role && agent.function_area"
                                class="text-gray-300"
                                >·</span
                            >
                            <span
                ...
                <Transition name="fade">
                    <div
                        ...
                        class="border-t border-gray-50 bg-gray-50/50 px-4 pt-2 pb-4"
                    >
                        <!-- Description -->
                        <div
                            v-if="agent.description"
                            class="mb-3 rounded-md bg-white px-3 py-2 text-xs leading-relaxed text-gray-600"
                        >
                            {{ agent.description }}
                        </div>
                        ...
                        <div class="mb-3 flex items-center gap-2">
                            <Link
                                ...
                                class="inline-flex items-center gap-1 rounded-md bg-white px-3 py-1.5 text-[11px] font-medium text-blue-600 ring-1 ring-gray-200 transition-colors ring-inset hover:bg-blue-50 hover:text-blue-700"
                            >
                            ...
                            <button
                                @click.prevent="
                                    deleteAgent(agent.id, agent.display_name)
                                "
                                class="inline-flex items-center gap-1 rounded-md bg-white px-3 py-1.5 text-[11px] font-medium text-red-500 ring-1 ring-gray-200 transition-colors ring-inset hover:bg-red-50 hover:text-red-700"
                            >
                        ...
                        <div v-if="agent.recent_events.length > 0" class="mb-3">
                            <p
                                class="mb-1.5 text-[10px] font-semibold tracking-wider text-gray-400 uppercase"
                            >
                                Recent Activity
                            </p>
                            <div class="space-y-1">
