...
const form = ref({
    ...
    primary_market: props.brand.primary_market || '',
    primary_kpi: props.brand.primary_kpi || '',
    brand_voice: props.brand.brand_voice || '',
    color: props.brand.color || '#6b7280',
                ...
                <div>
                    ...
                    <div class="flex items-center gap-2">
                        <input
                            type="color"
                            v-model="form.color"
                            class="h-8 w-8 cursor-pointer rounded border-gray-200"
                        />
                        <input
                            v-model="form.color"
                            class="flex-1 rounded border-gray-200 font-mono text-xs"
                        />
                    </div>
                </div>
