...
<template>
  <div class="flex flex-wrap items-center gap-2 border-b border-gray-200 px-4 py-2">
    ...
    <select
      ...
      @change="selectSegment(($event.target as HTMLSelectElement).value || null)"
    >
    ...
    <select
      ...
      @change="selectApproval(($event.target as HTMLSelectElement).value || null)"
    >
    ...
    <select
      ...
      @change="selectProgress(($event.target as HTMLSelectElement).value || null)"
    >
